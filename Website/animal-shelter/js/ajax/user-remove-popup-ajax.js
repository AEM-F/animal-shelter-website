            ...
            success: function (response) {
                switch(response) {
                    case "loggedUser":
                        ...
                        $(".user-remove-popup-container").append("<div class=\"user-remove-popup-wrapper\"><p class=\"user-remove-popup-header\"><i class=\"fas fa-exclamation-triangle\"></i>Warning</p><p class=\"user-remove-popup-text\">The following action will permantly remove your account from the system.You will be redirected to the home page. Are you sure you want to proceed?</p><div class=\"user-remove-popup-controls\"><div class=\"user-remove-popup-cancel-btn\">Cancel</div><div class=\"user-remove-popup-submit-btn\">Accept</div></div></div>");
                    ...
                    case "adminUser":
                        //$(".backdrop").show("fade", 300);
                        $(".user-remove-popup-container").append("<div class=\"user-remove-popup-wrapper\"><p class=\"user-remove-popup-header\"><i class=\"fas fa-exclamation-triangle\"></i>Warning</p><p class=\"user-remove-popup-text\">The following action will permantly remove an admin account.Are you sure you want to proceed?</p><div class=\"user-remove-popup-controls\"><div class=\"user-remove-popup-cancel-btn\">Cancel</div><div class=\"user-remove-popup-submit-btn\">Accept</div></div></div>");
                        $(".user-remove-popup-container").show("fade", 300);
                        $(".user-remove-popup-cancel-btn").click(function (e) { 
                            closeModalForPopup();
                        });
