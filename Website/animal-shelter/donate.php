...
<html lang="en">
    <head>
        ...
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAIKMiEng7L4L7NtK5lqI0Z1aFp-FwcZNU&callback=initMap&libraries=&v=weekly" defer></script>
    </head>
    <body>
        ...
        <div class="user-info-format">
            ...
            <div class="user-info-section">
                ...
                <div class="swiper-container">
                    <div class="parallax-bg" style="background-image: url(https://p1cdn4static.civiclive.com/UserFiles/Servers/Server_1881137/Image/Residents/Animal%20Services/Animal-banner-4.jpg);" data-swiper-parallax="-23%"></div>
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="text" data-swiper-parallax="-100">
                                <p>
                                    By donating a small amount, we will be able to provide animals with essencial products. Primarly cans of food, but also grooming care, and health care
                                </p>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            ...
                            <div class="text" data-swiper-parallax="-100">
                                <p>
                                    We implemented a gallery to introduce people to our pets that are available for adoption. Most of the animals on this website have an intersting past, which you can read about in their individual
                                    descriptions. We highly encourage you to take a look, as one of these lucky animals could be your new favorite family member.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="user-info-about-top" id="aboutUs_Top">
                ...
                <p id="demo">
                    As a group of people who want to help our four legged friends who are are struggling we ask of you to help them with us. Your gift today helps save lives Your contribution goes straight to work helping us feed and
                    nurture animals - by supporting our activities and helping us provide medical care.
                </p>
            </div>
        ...
        <!-- Initialize Swiper -->
        <script src="js/swiper-top-donate-page.js"></script>
    </body>
</html>